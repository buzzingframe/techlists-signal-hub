    ...
    Tables: {
      curated_list_products: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fk_curated_list_products_list_id"
            columns: ["list_id"]
            isOneToOne: false
            referencedRelation: "curated_lists"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_curated_list_products_product_id"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      curated_lists: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_curated_lists_created_by"
            columns: ["created_by"]
            isOneToOne: false
      ...
      saved_products: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_saved_products_product_id"
            columns: ["product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "fk_saved_products_user_id"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      user_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_user_preferences_user_id"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
